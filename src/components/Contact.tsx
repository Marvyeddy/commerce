...
const Contact = () => {
  return (
    <div className='bg-contact-bg bg-cover bg-center bg-no-repeat mt-7 px-5 py-32'>
      <div className='max-w-screen-md mx-auto flex-col flex items-center gap-2'>
        ...
        <div>
          ...
          <button className='ml-3 bg-gradient-to-tr from-purple-700 to-pink-600 text-white px-3 py-1 rounded-md'>
            Subscribe
          </button>
        </div>
